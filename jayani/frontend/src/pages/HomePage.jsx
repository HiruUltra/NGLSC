  ...
  const features = [
    {
      ...
      description:
        "Advanced AI-powered examination monitoring with real-time webcam tracking, violation detection, and automated alerts.",
    ...
    },
    {
      ...
      description:
        "Hands-free lecture recording with voice commands. Record, save, and manage your educational content effortlessly.",
    ...
    },
    {
      ...
      description:
        "AI-powered attendance tracking using TensorFlow object detection. Count students automatically from images.",
        ...
        >
          <div className="text-center space-y-8">
            ...
            <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Experience the future of education with AI-powered proctoring,
              voice-controlled lecture recording, and intelligent attendance
              tracking - all in one comprehensive platform.
            </p>
